...
if(!isset($err)){
$db->query("INSERT INTO `user_files` (`id_user`, `name`, `msg`,  `time`, `id_dir`, `osn`, `id_dires`, `pass`) values('$user[id]', '".my_esc($name)."','".my_esc($msg)."',  '$time', '$dir[id]', '$osn', '$id_dires', '".my_esc($pass)."')");
