...
echo "</div>";
$k_post=$db->query("SELECT COUNT(*) FROM `status` WHERE `id_user` = '".$anketa['id']."'");
...
echo "</div>";
echo "<a href='komm.php?id=$post[id]'><img src='/style/icons/bbl4.png' alt=''/>" . $db->query("SELECT COUNT(*) FROM `status_komm` WHERE `id_status` = '$post[id]'") . "</a> ";
if ($post['pokaz']==0){
