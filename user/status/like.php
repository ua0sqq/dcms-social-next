...
echo "</div>";
$k_post=$db->query("SELECT COUNT(*) FROM `status_like` WHERE `id_status` = '".$id."'")->el();
$k_page=k_page($k_post, $set['p_str']);
$page=page($k_page);
$start=$set['p_str']*$page-$set['p_str'];
$q=$db->query("SELECT * FROM `status_like` WHERE `id_status` = '".$id."' ORDER BY `id` DESC LIMIT $start, $set[p_str]");
