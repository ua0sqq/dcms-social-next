...
class MP3_Id
{
    ...
    public $genre = '';
    public $genreno = 255;
    public $studied = false;
    public $mpeg_ver = 0;
    public $layer = 0;
    public $bitrate = 0;
    public $crc = false;
    public $frequency = 0;
    public $encoding_type = 0;
    public $samples_per_frame = 0;
    public $samples = 0;
    public $musicsize = -1;
    public $frames = 0;
    public $quality = 0;
    ...
    public $lengthh = false;
    public $length = false;
    public $lengths = false;
    public $error = false;
    public $debug = false;
    public $debugbeg = '<DIV STYLE="margin: 0.5 em; padding: 0.5 em; border-width: thin; border-color: black; border-style: solid">';
    public $debugend = '</DIV>';
    ...
    public function _decode_v1($rawtag)
    {
        if ($this->debug) {
