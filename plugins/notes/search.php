...
if (isset($_GET['go']))
{
$k_post=$db->query("SELECT COUNT(*) FROM `notes` where `name` like '%".my_esc($usearch)."%'");
$k_page=k_page($k_post,$set['p_str']);
$page=page($k_page);
$start=$set['p_str']*$page-$set['p_str'];
$q=$db->query("SELECT * FROM `notes` WHERE `name` like '%".my_esc($usearch)."%' $order LIMIT $start, $set[p_str]");
