...
$kount=$db->query("SELECT COUNT(*) FROM `notes_dir` WHERE `id` = '$id_dir' ");
}
...
$k_post=$db->query("SELECT COUNT(*) FROM `notes`  WHERE `id_dir` = '$id_dir'");
...
$k_n= $db->query("SELECT COUNT(*) FROM `notes` WHERE `id` = $post[id] AND `time` > '".$ftime."'",$db);
...
==================================
*/
$k_post=$db->query("SELECT COUNT(*) FROM `notes_dir` ");
...
$k_pp=$db->query("SELECT COUNT(*) FROM `notes`  WHERE `id_dir` = '$post[id]'");
$k_nn=$db->query("SELECT COUNT(*) FROM `notes`  WHERE `id_dir` = '$post[id]' AND `time` > '$ftime'");
if ($k_nn>0)
