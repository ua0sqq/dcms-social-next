...
if (isset($_GET['id']) && $db->query("SELECT COUNT(*) FROM `notes` WHERE `id` = '".intval($_GET['id'])."'")==1)
{
...
if (isset($_GET['komm']) && $db->query("SELECT COUNT(*) FROM `notes_komm` WHERE `id` = '".intval($_GET['komm'])."'")==1)
{
...
if (isset($_GET['dir']) && $db->query("SELECT COUNT(*) FROM `notes_dir` WHERE `id` = '".intval($_GET['dir'])."'")==1)
{
