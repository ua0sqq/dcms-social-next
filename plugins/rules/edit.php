...
{
	if (isset($_GET['id']) && $db->query("SELECT COUNT(*) FROM `rules_p` WHERE `id` = '".intval($_GET['id'])."'")==1)
	{	$post=$db->query("SELECT * FROM `rules_p` WHERE `id` = '".intval($_GET['id'])."' LIMIT 1")->row();
...
{
	if (isset($_GET['id']) && $db->query("SELECT COUNT(*) FROM `rules` WHERE `id` = '".intval($_GET['id'])."'")==1)
	{
